...
{
    public class DivisoesResource
    {
        public bool status { get; set; }
        public string? message { get; set; }
        public MarcasErros? erros { get; set; }
        public Divisoes? data { get; set; }
    }

    public class DivisoesErros
    {
        public List<string>? id { get; set; }
        public List<string>? nome { get; set; }
        public List<string>? ramo { get; set; }
        public List<string>? cnpj { get; set; }
        public List<string>? cor_primaria { get; set; }
        public List<string>? cor_secundaria { get; set; }
        public List<string>? cor_tercearia { get; set; }
